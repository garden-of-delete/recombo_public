...
public:
	recomboFromFile(int Min_arc, int Max_arc, char* Infile, char* Outfile, int n_components, char read_mode, int sampling_mode, int block_file_mode, bool supress_output, bool info_mode, char orientation);
	void do_recombo();
	~recomboFromFile();
};
